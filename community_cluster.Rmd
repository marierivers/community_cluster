...
The Bray Curtis distance metric focuses on species counts, particularly the sum of the lowest counts of shared species between two sites compared to the total cound of all species. For Bray Curtis, a dissimilarity value of 1 means that two sites have no species in common and are therefore completly disimilar. A Bray Curtis values of 0 means that two sites are identical.
