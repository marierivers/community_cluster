...
**Question:** How many observations could be considered "misclassified" if expecting bill length and bill depth to differentiate between species?

In this evaluation, the Chinstrap penguins are group 1, the Adelie penguins are group 2, and the Gentoo penguins are group 3. The model performs best at identifying the Adelies. If bill length and bill depth are used to differentiate between species, then a total of 84 observations (45 Gentoo misidentified as Chinstrap, 1 Chinstrap misidentified as Adelie, 11 Adelie misidentified as Gentoo, and 27 Chinstap misidentified as Gentoo) would be misclassified. A total of 249 penguins were correctly identified (40 Chinstap, 135 Adelie, and 74 Gentoo).
xxx...
```{r}
